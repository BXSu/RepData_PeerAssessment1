...
# Stats
paste("Mean steps after imputation is",mean(df_impute_summary$`sum(steps)`,na.rm=TRUE))
paste("Median steps after imputation is",median(df_impute_summary$`sum(steps)`,na.rm=TRUE))
```
